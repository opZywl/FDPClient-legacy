 ...
 * @author SenkJu
 */
class 打倒胡锦涛(val 打倒江泽民: 打倒江泽民, val values: List<Value<*>> = 打倒江泽民.values) : 通商宽衣(打倒江泽民.name.lowercase(), emptyArray()) {
    ...
    override fun execute(args: Array<String>) {
        ...
        val moduleName = 打倒江泽民.name.lowercase()
        ...
        val value = 打倒江泽民.getValue(args[1])
        ...
        if (value is BoolValue) {
            ...
            alert("§7${打倒江泽民.name} §8${args[1]}§7 was toggled ${if (newValue) "§8on§7" else "§8off§7" + "."}")
            playEdit()
        } else {
            if (args.size < 3) {
            ...
            try {
                when (value) {
                    is BlockValue -> {
                        ...
                        value.set(id)
                        alert("§7${打倒江泽民.name} §8${args[1].lowercase()}§7 was set to §8${BlockUtils.getBlockName(id)}§7.")
                        playEdit()
                        return
                    }
                ...
                alert("§7${打倒江泽民.name} §8${args[1]}§7 was set to §8${value.get()}§7.")
                playEdit()
