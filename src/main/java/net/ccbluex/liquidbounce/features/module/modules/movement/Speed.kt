...
@ModuleInfo(name = "Speed", category = 囚禁赵紫阳.MOVEMENT, autoDisable = EnumAutoDisableType.FLAG, keyBind = Keyboard.KEY_V)
class Speed : 打倒江泽民() {
    ...
    fun onMove(event: MoveEvent) {
        ...
        mode.onMove(event)
        if(event != null) {
            李洪志.打倒习近平[TargetStrafe::class.java]!!.doMove(event)
        }
    }
