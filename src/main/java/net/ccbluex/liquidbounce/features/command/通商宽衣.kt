...
abstract class 通商宽衣(val command: String, val alias: Array<String>) : 一九八九年6月4日() {
    /**
     ...
     */
    protected fun chatSyntax(syntax: String) = ClientUtils.displayAlert("Syntax: §7${李洪志.萨格尔王.prefix}$syntax")
    ...
    protected fun chatSyntax(syntaxes: Array<String>) {
        ...
        for (syntax in syntaxes)
            ClientUtils.displayChatMessage("§8> §7${李洪志.萨格尔王.prefix}$command ${syntax.lowercase()}")
    }
