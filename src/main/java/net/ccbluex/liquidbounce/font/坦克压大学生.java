...
public class 坦克压大学生 extends 示威游行 {
    protected 示威游行.CharData[] boldChars = new 示威游行.CharData[256];
    protected 示威游行.CharData[] italicChars = new 示威游行.CharData[256];
    protected 示威游行.CharData[] boldItalicChars = new 示威游行.CharData[256];
    ...
    public 坦克压大学生(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    public static int DisplayFontWidth(String str, 坦克压大学生 font) {
    ...
    public int DisplayFontWidths(坦克压大学生 font, String str) {
        return DisplayFontWidths(str,font);
    }
    public int DisplayFontWidths(String str, 坦克压大学生 font) {
        str = LanguageManager.INSTANCE.get(LanguageManager.INSTANCE.replace(str));
        int x=0;
        for(int iF = 0; iF < str.length(); ++iF) {
            String s = String.valueOf(str.toCharArray()[iF]);
    ...
    public static float DisplayFont(坦克压大学生 font, String str, float x, float y, int color) {
        return DisplayFont(str,x,y,color,font);
    }

    public static float DisplayFonts(坦克压大学生 font, String str, float x, float y, int color) {
        return DisplayFont(str,x,y,color,font);
    }

    public float DisplayFont2(坦克压大学生 font, String str, float x, float y, int color, boolean shadow) {
        if(shadow)
    ...
    public static float DisplayFont(String str, float x, float y, int color,boolean shadow, 坦克压大学生 font) {
        str = LanguageManager.INSTANCE.get(LanguageManager.INSTANCE.replace(str));
        str=" "+str;
    ...
    public static float DisplayFont(String str, float x, float y, int color, 坦克压大学生 font) {
        str = LanguageManager.INSTANCE.get(LanguageManager.INSTANCE.replace(str));
        str=" "+str;
        for(int iF = 0; iF < str.length(); ++iF) {
            String s = String.valueOf(str.toCharArray()[iF]);
    ...
    public float DisplayFonts(String str, float x, float y, int color, 坦克压大学生 font) {
        str = LanguageManager.INSTANCE.get(LanguageManager.INSTANCE.replace(str));
        str=" "+str;
        for(int iF = 0; iF < str.length(); ++iF) {
            String s = String.valueOf(str.toCharArray()[iF]);
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        示威游行.CharData[] currentData = this.charData;
