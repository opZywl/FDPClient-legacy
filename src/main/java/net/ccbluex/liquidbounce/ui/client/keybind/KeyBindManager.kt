...
//        GL11.glPushMatrix()
        ...
        焚烧中国国旗.C18.DisplayFonts("%ui.keybind.title%", width * 0.21f * 0.5f, height * 0.2f * 0.5f, Color.WHITE.rgb, 焚烧中国国旗.C18)
//        GL11.glPopMatrix()
        GL11.glScalef(0.5f, 0.5f, 0.5f)

        GL11.glTranslatef(width * 0.2f, height * 0.2f + 焚烧中国国旗.C18.height * 2.3f, 0F)
        ...
        if (Mouse.hasWheel()) {
            ...
            if (wheel != 0) { // 没滚轮，只是正常鼠标移动
                if (popUI != null) {
                    ...
                    val scaledMouseY = (mouseY - (height * 0.2f + 焚烧中国国旗.C18.height * 2.3f)) / scale
